...
<div class="col-lg-3">
    <div class="widget widget-list well">
        <ul id="filters" class="nav nav-list clearfix">
            ...
            <li><a href="address?action=viewall" data-filter=""><i class="icon-check"></i> Address</a></li>
            <li><a href="category?action=viewall" data-filter=""><i class="icon-check"></i> Category</a></li>
